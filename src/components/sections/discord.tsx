        ...
        <section className="py-16 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                >
                    ...
                    <Button
                        className="bg-[#5865F2] hover:bg-[#4752C4] text-white text-lg py-3 px-4 h-auto rounded-full shadow-[0_0_30px_rgba(88,101,242,0.4)] hover:shadow-[0_0_50px_rgba(88,101,242,0.6)] transition-all duration-300 transform hover:scale-105"
                    >
